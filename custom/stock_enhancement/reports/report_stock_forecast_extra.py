...
class ReportStockForecatExtra(models.Model):
    ...
    @api.model_crz
    def init(self):
        tools.drop_view_if_exists(self._cr, 'report_stock_quantity_extra')
        query = """CREATE or REPLACE VIEW report_stock_quantity_extra AS (
SELECT
    MIN(id) as id,
